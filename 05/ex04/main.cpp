...
void new_tests()
{
	Intern intern;
	Bureaucrat lame("LameMan", LOWEST_GRADE);
	Bureaucrat signatory = Bureaucrat("Mike", 25);
	Bureaucrat executive = Bureaucrat("Lara", 5);
	OfficeBlock ob;
	try
	{
		ob.doBureaucracy("qwerty", "uiop");
	}
	catch (std::exception & e)
	{
		std::cout << e.what() << std::endl;
	...
	catch (OfficeBlock::OfficeBlockIsntFilledException & e)
	{
		std::cout << e.what() << std::endl;
	}
	catch (std::exception & e)
	...
	ob.setIntern(&intern);
	ob.setSignatory(&lame);
	ob.setExecutive(&lame);
	try
	{
		ob.doBureaucracy("pay stub", "Bob");
	}
	catch (OfficeBlock::UnknownFormNameException & e)
	{
		std::cout << e.what() << std::endl;
	}
	catch (std::exception & e)
	...
	try
	{
		ob.doBureaucracy("presidential pardon", "Bob");
	}
	catch (OfficeBlock::SignatoryGradeTooLowExecption & e)
	{
		std::cout << e.what() << std::endl;
	}
	catch (std::exception & e)
	...
	ob.setSignatory(&signatory);
	try
	{
		ob.doBureaucracy("presidential pardon", "Bob");
	}
	catch (OfficeBlock::ExecutiveGradeTooLowExecption & e)
	{
		std::cout << e.what() << std::endl;
	}
	catch (std::exception & e)
