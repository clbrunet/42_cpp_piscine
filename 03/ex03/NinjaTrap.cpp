...
NinjaTrap::NinjaTrap(void)
	:	ClapTrap("N1NJ4-TP", 60, 60, 120, 120, 1, "Robby", 60, 5, 0)
{
...
{
	std::cout << "N1NJ4-TP " << this->name_ << " asks FR4G-TP "
...
{
	std::cout << "N1NJ4-TP " << this->name_ << " completely ignore SC4V-TP "
